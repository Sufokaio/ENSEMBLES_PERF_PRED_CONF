...
8 subplots (one per dataset). x = 4 metrics (left→right).
y = rank 1-8 (1=best at top). 8 colored lines, one per model.
Flat line = metric-consistent model. Steep cross = metric-sensitive.
"""
import os
import numpy as np
import pandas as pd
